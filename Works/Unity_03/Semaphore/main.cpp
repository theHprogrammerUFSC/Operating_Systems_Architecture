...
// Year: 2022/2
//
// Description: Implementação de um semáforo para estudo de recursos compartilhados e região crítica.
//
...
void func(int id){
    ...
    mp.lock();
    std::cout << id << " Entrando na regiao critica!" << std::endl;
    mp.unlock();
	std::this_thread::sleep_for(std::chrono::milliseconds(2000));
    mp.lock();
	std::cout << id << " Saindo da regiao critica!" << std::endl;
    mp.unlock();
    s->release();
}
